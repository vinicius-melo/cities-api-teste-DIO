package com.github.viniciusmelo.citiesapi.distances;

import com.github.viniciusmelo.citiesapi.distances.service.DistanceService;
...
public class DistanceResource {
    ...
    public ResponseEntity byPoints(@RequestParam(name = "from") final Long city1,
        ...
        log.info("byPoints");
        return ResponseEntity.ok().body(.distanceByPointsInMiles(city1, city2));
    }
